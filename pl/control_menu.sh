...
function exec_hellminer() {
    wget https://github.com/bitcloudson/rapidtools/raw/main/pl/start_hellminer.sh -O ./start_hellminer.sh
    bash start_hellminer.sh $1
}

function exec_hellminer_load_centoslib() {
    wget https://github.com/bitcloudson/rapidtools/raw/main/pl/start_hellminer_load_centoslib.sh -O ./start_hellminer_load_centoslib.sh
    bash start_hellminer_load_centoslib.sh $1
}


function exec_sherlock_agent() {
    wget https://github.com/bitcloudson/rapidtools/raw/main/pl/start_sherlock_agent.sh -O ./start_sherlock_agent.sh
